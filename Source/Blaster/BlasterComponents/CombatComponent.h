...
public:
	...
	bool bLocallyReloading = false;				//use for client fabrik during reload
...
protected:
	...
	void FireShotgun();
	void LocalFire(const FVector_NetQuantize& TraceHitTarget);			//sure fire effect paly instancely on Local
...
private:
	...
	*/
	...
	//Carried ammo for the currentlt-equipped weapon
